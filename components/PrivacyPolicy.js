...
const PrivacyPolicy = () => {
  return (
    <>
      ...
      <div className="font-bold mx-4 sm:mx-8 md:mx-14 lg:mx-20 my-4 uppercase font-sans  sm:text-xl md:text-2xl">
        1. INTRODUCTION
      </div>
      <div className="mx-4 sm:mx-8 md:mx-14 lg:mx-20 my-2 font-sans">
        1.1. PURPOSE OF POLICY. AbideInspire.com (us, we, Non-Profit
        Orgainzation) is committed to respecting the privacy rights of visitors
        and other users of this site. We created this Privacy Policy (this
        Policy) to give you confidence as you visit and use the Site, and to
        demonstrate our commitment to fair information practices. This Policy is
        only applicable to the Site, and not to any other websites that you may
        be able to access from the Site, each of which may have data collection
        and use practices and policies that differ materially from this Policy.
      </div>
      <div className="mx-4 sm:mx-8 md:mx-14 lg:mx-20 my-2 font-sans">
        <p className="font-bold">1.2. NOTICE CONCERNING CHILDREN</p>
        LEASE NOTE: We are a general audience site, and do not direct any of our
        content specifically at children under 13 years of age pursuant to the
      ...
      <div className="mx-4 sm:mx-8 md:mx-14 lg:mx-20 my-2 font-sans">
        ...
        the contact page. In doing so, you will provide us with your name and
        email address. You are not required to provide us with information via
        these methods to use and enjoy the Site.
      </div>
      <div className="mx-4 sm:mx-8 md:mx-14 lg:mx-20 my-2 font-sans">
        <p className="font-bold">
      ...
      <div className="mx-4 sm:mx-8 md:mx-14 lg:mx-20 my-2 font-sans">
        <p className="font-bold">
          3 WHAT DOES WE DO WITH COLLECTED INFORMATION?
        </p>
        <p className="my-2">
          ...
          use to facilitate the functioning of the site such as a hosting we and
          email program for mailings.
        </p>
        <p className="my-2">
        ...
        <p className="my-2">
          ...
          business, we may sell or buy portions of the Site, including the
          information collected through this Site. If substantially all of its
      ...
      <div className="mx-4 sm:mx-8 md:mx-14 lg:mx-20 my-2 font-sans">
        The Site has security measures in place to prevent the loss, misuse, and
        alteration of the information that we obtain from you, but we make no
        assurances about our ability to prevent any such loss to you or to any
        third party arising out of any such loss, misuse, or alteration.
      </div>
      <div className="font-bold mx-4 sm:mx-8 md:mx-14 lg:mx-20 my-4 uppercase font-sans  sm:text-xl md:text-2xl">
        5. WEBSITE AREAS BEYOND OUR CONTROL
      </div>
      <div className="mx-4 sm:mx-8 md:mx-14 lg:mx-20 my-2 font-sans">
        <p className="font-bold">5 THIRD PARTY WEBSITES</p>
        From time-to-time, the Site may contain links to other websites. If you
        choose to visit those websites, it is important to understand our
        privacy practices and terms of use do not extend to those sites. It is
        your responsibility to review the privacy policies at those websites to
        confirm that you understand and agree with their practices.
      </div>
      <div className="font-bold mx-4 sm:mx-8 md:mx-14 lg:mx-20 my-4 uppercase font-sans  sm:text-xl md:text-2xl">
        6. CONTACT INFORMATION AND POLICY UPDATES
      </div>
      <div className="mx-4 sm:mx-8 mb-10 md:mx-14 lg:mx-20 my-2 font-sans">
        <p className="font-bold">6.1. CONTACTING US</p>
        If you have any questions about this Policy or our practices related to
        this Site, please feel contact us.
        <p className="font-bold">6.2. UPDATES AND CHANGES</p>
        We reserve the right, at any time, to add to, change, update, or modify
        this Policy to reflect changes in our Privacy Policy. We shall post any
        such changes on the Site in a conspicuous area. You may then choose
        whether you wish to accept said policy changes or discontinue using the
        Site. Any such change, update, or modification will be effective 30 days
        after posting on the Site. It is your responsibility to review this
        Policy from time to time to ensure that you continue to agree with all
        of its terms.
      </div>
    </>
  );
